...
# Part 1
hdul1 = fits.open("lightcurve_cdte2.fits")
data1 = hdul1[5].data
...
# Part 2
hdul2 = fits.open("lightcurve_cdte2_1.fits")
data2 = hdul2[5].data
...
plt.title("HEL1OS CDTE2 Light Curve")
...
plt.plot(unix_time, ctr)
plt.title("HEL1OS CDTE2 Flare Detection Analysis")
plt.xlabel("TIME (Unix)")
plt.ylabel("Count Rate (CTR)")
